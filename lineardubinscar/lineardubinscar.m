%% Main function of the closed-loop trajectory tracking controller for the linearsystem of dubinscar
clc;
clear all;
close all;
...
%x0 = [9, 15, 0.5, 8];
x0 = [11.0,21.0,10*cos(0.5),10*sin(0.5)]';

options = odeset('RelTol',1e-4,'AbsTol',[1e-4, 1e-4, 1e-4, 1e-4]);
[T,X] = ode45(@(t,x) odelineardubinscarTracking(t,x, trajparam, conparam),[t0 tf],x0, options);
